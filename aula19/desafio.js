(function(){
    ...
    */
    ...
    let justNumbersRegex = /^\d+/gm;

    console.log( 'Regex para números usando o construtor:' );
    console.log(justNumbersRegex);

   /* 
    var testString = "7987987 te\nste 5655 funciona? \n977 será mesmo?? \n546 ";
    var matches = testString.match(justNumbersRegex);
    console.log(matches); 
    */
    ...
    */
    ...
    let matches = text.match(justNumbersRegex);
    console.log(matches);
    ...
    */
    ...
    let matchesOtherText = otherText.match(numbersAtTheEnd);
    console.log(matchesOtherText)
    ...
    */
    ...
    function hasClass(markup, cssClass) {
        ...
        var regex = new RegExp('\\bclass\\s*=\\s*[\'"](?:[^\'"]*\\s+)?' + cssClass + '(?:\\s+[^\'"]*)?[\'"]'); 
